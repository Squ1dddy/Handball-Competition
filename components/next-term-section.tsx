...
// Collapsible "TBD Next Term" group for Year 11 matches. Public, but collapsed by
...
export function NextTermSection({ matches }: { matches: EnrichedMatch[] }) {
  ...
  return (
    <section className="space-y-4">
      ...
      >
        <div>
          <p className="eyebrow text-volt">Year 11 · Date TBD</p>
          <h2 className="mt-1 font-display text-2xl uppercase tracking-wide text-bone">TBD Next Term</h2>
        </div>
